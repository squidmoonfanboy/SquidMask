...
import io.squidmask.nativeModules.RCTAnalyticsPackage;
...
import io.squidmask.nativeModules.PreventScreenshotPackage;
    ...
    private static void initializeFlipper(
    	...
    	if (BuildConfig.DEBUG) {
    		try {
    		  ...
    		  */
    		  Class<?> aClass = Class.forName("io.squidmask.ReactNativeFlipper");
    		  aClass
